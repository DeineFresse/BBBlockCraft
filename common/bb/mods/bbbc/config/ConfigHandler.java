...
public class ConfigHandler {
	...
	public static void init(File file){
		...
		LoadedIDs.Block_TestBlock = config.getBlock("TestBlock",DefaultIDs.BLOCK_TESTBLOCK).getInt();
		LoadedIDs.Block_cloudore = config.getBlock("cloudore",DefaultIDs.BLOCK_CLOUDORE).getInt();
		LoadedIDs.Block_CloudWhite = config.getBlock("CloudWhite",DefaultIDs.BLOCK_CLOUDWHITE).getInt();
		LoadedIDs.Block_Dark_Stone = config.getBlock("Dark_Stone",DefaultIDs.BLOCK_DARK_STONE).getInt();
		LoadedIDs.Block_Faceblock = config.getBlock("Faceblock",DefaultIDs.BLOCK_FACEBLOCK).getInt();
		LoadedIDs.Block_BigBlock = config.getBlock("BigBlock",DefaultIDs.BLOCK_BIGBLOCK).getInt();
