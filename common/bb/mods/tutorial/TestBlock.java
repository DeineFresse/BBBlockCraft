...
import bb.mods.tutorial.structures.BrickHouse;
import bb.mods.tutorial.structures.Spacetest1;
        ...
        public String getTextureFile()
{
	...
	public int Houscheck(World par1,int par2,int par3,int par4,int par5,EntityPlayer par6){
		...
		if(bb.mods.tutorial.BBBlockCraft.getdebugmode())par6.addChatMessage("?");
